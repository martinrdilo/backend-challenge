...
/**
 * Integration tests for NotificationController with JWT authentication. Tests CRUD: create, list
 * own, get by id (with ownership), update, delete.
 */
class NotificationControllerIntegrationTest extends AbstractIntegrationTest {
  ...
  void shouldCreateNotificationWhenAuthenticated() {
    ...
    NotificationRequest request =
        new NotificationRequest("Test Title", "Test Content", Channel.EMAIL, List.of());
  ...
  void shouldSetStatusToSentForSmsChannelWithLongContent() {
    ...
    NotificationRequest request =
        new NotificationRequest("SMS Notification", longContent, Channel.SMS, List.of());
  ...
  void shouldSetStatusToSentForPushChannel() {
    ...
    NotificationRequest request =
        new NotificationRequest(
            "Push Notification", "Push message content", Channel.PUSH, List.of());
  ...
  void shouldListOwnNotifications() {
    ...
    NotificationRequest r1 =
        new NotificationRequest("First", "Content 1", Channel.EMAIL, List.of());
  ...
  void shouldReturn401WhenListingNotificationsWithoutToken() {
    webTestClient().get().uri("/notifications").exchange().expectStatus().isUnauthorized();
  }
  ...
  void shouldReturn403WhenGettingAnotherUsersNotification() {
    ...
    NotificationRequest req =
        new NotificationRequest("B's Notification", "Secret", Channel.EMAIL, List.of());
    var result =
        webTestClient()
            .post()
            .uri("/notifications")
  ...
  void shouldUpdateOwnNotification() {
    ...
    NotificationRequest createReq =
        new NotificationRequest("Old Title", "Old Content", Channel.EMAIL, List.of());
    webTestClient()
        .post()
        .uri("/notifications")
        .header("Authorization", "Bearer " + token)
    ...
    NotificationUpdateRequest updateReq =
        new NotificationUpdateRequest("New Title", "New Content", List.of(1L, 2L));
    ...
    webTestClient()
        ...
        .isArray()
        .jsonPath("$.attachments.length()")
        .isEqualTo(2)
        .jsonPath("$.attachments[0].id")
        .isEqualTo(1)
        .jsonPath("$.attachments[1].id")
        .isEqualTo(2);
  }
  ...
  void shouldClearAttachmentsOnUpdate() {
    ...
    NotificationRequest createReq =
        new NotificationRequest("With Attachments", "Content", Channel.EMAIL, List.of(1L));
    webTestClient()
        .post()
        .uri("/notifications")
        .header("Authorization", "Bearer " + token)
    ...
    NotificationUpdateRequest updateReq =
        new NotificationUpdateRequest("Updated", "New Content", null);
  ...
  void shouldReturn403WhenUpdatingAnotherUsersNotification() {
    ...
    NotificationUpdateRequest updateReq =
        new NotificationUpdateRequest("Hacked", "Evil", List.of());
    webTestClient()
        .put()
        .uri("/notifications/{id}", notificationId)
        .header("Authorization", "Bearer " + tokenA)
  ...
  void shouldReturn404WhenUpdatingNonExistentNotification() {
    ...
    NotificationUpdateRequest updateReq =
        new NotificationUpdateRequest("Title", "Content", List.of());
    webTestClient()
        .put()
  ...
  void shouldReturn400WhenUpdatingWithBlankTitle() {
    ...
    // Create a notification first
    NotificationRequest createReq =
        new NotificationRequest("Valid", "Content", Channel.EMAIL, List.of());
    webTestClient()
        .post()
        .uri("/notifications")
        .header("Authorization", "Bearer " + token)
  ...
  void shouldDeleteOwnNotification() {
    ...
    NotificationRequest createReq =
        new NotificationRequest("To Delete", "Bye", Channel.EMAIL, List.of());
    webTestClient()
        .post()
        .uri("/notifications")
        .header("Authorization", "Bearer " + token)
  ...
  void shouldGetOwnNotifications() {
    ...
    // Create a notification first
    NotificationRequest request =
        new NotificationRequest("My Notification", "My Content", Channel.SMS, List.of());
  ...
  void shouldReturn400WhenCreatingWithNullTitle() {
    ...
    NotificationRequest request =
        new NotificationRequest(null, "Valid Content", Channel.EMAIL, List.of());
  ...
  void shouldReturn400WhenCreatingWithBlankContent() {
    ...
    NotificationRequest request =
        new NotificationRequest("Valid Title", "", Channel.EMAIL, List.of());
  ...
  void shouldCreateNotificationWithSmsChannel() {
    ...
    NotificationRequest request =
        new NotificationRequest("SMS Title", "SMS Body", Channel.SMS, List.of());
  ...
  void shouldCreateNotificationWithPushChannel() {
    ...
    NotificationRequest request =
        new NotificationRequest("Push Title", "Push Body", Channel.PUSH, List.of());
  ...
  void shouldCreateNotificationWithEmailChannel() {
    ...
    NotificationRequest request =
        new NotificationRequest("Email Title", "Email Body", Channel.EMAIL, List.of());
  ...
  void shouldReturnDefaultPagination() {
    ...
    for (int i = 0; i < 3; i++) {
      NotificationRequest req =
          new NotificationRequest("Title " + i, "Content " + i, Channel.EMAIL, List.of());
      webTestClient()
          .post()
          .uri("/notifications")
          .header("Authorization", "Bearer " + token)
  ...
  void shouldFilterByStatus() {
    ...
    NotificationRequest req1 =
        new NotificationRequest("Sent 1", "Content", Channel.EMAIL, List.of());
    webTestClient()
        .post()
        .uri("/notifications")
        .header("Authorization", "Bearer " + token)
  ...
  void shouldSearchByText() {
    ...
    webTestClient()
        ...
        .bodyValue(
            new NotificationRequest(
                "Invoice Reminder", "Your invoice is ready", Channel.EMAIL, List.of()))
        .exchange()
        .expectStatus()
        .isCreated();
  ...
  void shouldApplyCombinedCriteria() {
    ...
    webTestClient()
        ...
        .contentType(MediaType.APPLICATION_JSON)
        .bodyValue(
            new NotificationRequest("Invoice Alert", "Invoice content", Channel.EMAIL, List.of()))
        .exchange()
        .expectStatus()
        .isCreated();
    ...
    webTestClient()
        ...
        .contentType(MediaType.APPLICATION_JSON)
        .bodyValue(
            new NotificationRequest("Invoice SMS", "Invoice via SMS", Channel.SMS, List.of()))
        .exchange()
        .expectStatus()
        .isCreated();
  ...
  void shouldEnforceCrossUserIsolation() {
    ...
    webTestClient()
        ...
        .contentType(MediaType.APPLICATION_JSON)
        .bodyValue(
            new NotificationRequest("A's Notification", "A's content", Channel.EMAIL, List.of()))
        .exchange()
        .expectStatus()
        .isCreated();
    ...
    webTestClient()
        ...
        .contentType(MediaType.APPLICATION_JSON)
        .bodyValue(
            new NotificationRequest("B's Notification", "B's content", Channel.EMAIL, List.of()))
        .exchange()
        .expectStatus()
        .isCreated();

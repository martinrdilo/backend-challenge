...
public class NotificationController {
  ...
  public ResponseEntity<Page<EnrichedNotificationResponse>> getMyNotifications(
    ...
    NotificationCriteria criteria =
        new NotificationCriteria(status, channel, createdAfter, createdBefore, search);
  ...
  public ResponseEntity<EnrichedNotificationResponse> retryNotification(@PathVariable Long id) {
